...
#define  APP_CFG_THREAD1_TASK_STK_SIZE                     128u
#define  APP_CFG_THREAD2_TASK_STK_SIZE                     128u
#define  APP_CFG_THREAD3_TASK_STK_SIZE                     1024u
...
#define  APP_CFG_THREAD1_TASK_STK_SIZE_PCT_FULL            90u
#define  APP_CFG_THREAD1_TASK_STK_SIZE_LIMIT       (APP_CFG_THREAD1_TASK_STK_SIZE     * (100u - APP_CFG_THREAD1_TASK_STK_SIZE_PCT_FULL))    / 100u
#define  APP_CFG_THREAD1_TASK_PRIO                4

#define  APP_CFG_THREAD2_TASK_STK_SIZE_PCT_FULL            90u
#define  APP_CFG_THREAD2_TASK_STK_SIZE_LIMIT       (APP_CFG_THREAD2_TASK_STK_SIZE     * (100u - APP_CFG_THREAD2_TASK_STK_SIZE_PCT_FULL))    / 100u
#define  APP_CFG_THREAD2_TASK_PRIO                6

#define  APP_CFG_THREAD3_TASK_STK_SIZE_PCT_FULL            90u
#define  APP_CFG_THREAD3_TASK_STK_SIZE_LIMIT       (APP_CFG_THREAD3_TASK_STK_SIZE     * (100u - APP_CFG_THREAD3_TASK_STK_SIZE_PCT_FULL))    / 100u
#define  APP_CFG_THREAD3_TASK_PRIO                5
